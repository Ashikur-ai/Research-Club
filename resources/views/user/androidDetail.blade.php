...
{{--                            <h2 class="text-center">Android Project</h2>--}}
{{--                        </div>--}}
{{--                        <div class="row">--}}
{{--                            <div class="col-6 my-4">--}}
{{--                                <img height="100px" width="400px" class="" src="{{ asset('/') }}/androidImage/{{ $data->image }}" alt="">--}}
{{--                            </div>--}}
{{--                            <div class="col-6 my-4">--}}
                ...
                <div class="container">
                    ...
                    <dl class="row">
                        <div class="col-12 p-1 my-5 alert alert-success">
                            <h2 class="text-center">Android Project details</h2>
                        </div>
                        <div class="row">
                            <div class="align-content-center">
                                <img height="300 px"  src="{{ asset('/') }}/androidImage/{{ $data->image }}" alt="">
                            </div>
